...
// AddStrainPhenotype is the resolver for the addStrainPhenotype field.
func (r *mutationResolver) AddStrainPhenotype(ctx context.Context, strainID string, input models.AddStrainPhenotypeInput) (*models.Strain, error) {
	panic(fmt.Errorf("not implemented: AddStrainPhenotype - addStrainPhenotype"))
}

// UpdateStrainPhenotype is the resolver for the updateStrainPhenotype field.
func (r *mutationResolver) UpdateStrainPhenotype(ctx context.Context, strainID string, target models.UpdateStrainPhenotypeTargetInput, payload models.UpdateStrainPhenotypePayloadInput) (*models.Strain, error) {
	panic(fmt.Errorf("not implemented: UpdateStrainPhenotype - updateStrainPhenotype"))
}

// DeleteStrainPhenotype is the resolver for the deleteStrainPhenotype field.
func (r *mutationResolver) DeleteStrainPhenotype(ctx context.Context, strainID string, input models.DeleteStrainPhenotypeInput) (*models.DeleteStrainPhenotype, error) {
	panic(fmt.Errorf("not implemented: DeleteStrainPhenotype - deleteStrainPhenotype"))
}
...
// CreateGeneGeneralInfo is the resolver for the createGeneGeneralInfo field.
func (r *mutationResolver) CreateGeneGeneralInfo(ctx context.Context, id string, input models.CreateGeneGeneralInfoInput) (*models.GeneGeneralInfo, error) {
	panic(fmt.Errorf("not implemented: CreateGeneGeneralInfo - createGeneGeneralInfo"))
}

// UpdateGeneGeneralInfo is the resolver for the updateGeneGeneralInfo field.
func (r *mutationResolver) UpdateGeneGeneralInfo(ctx context.Context, id string, input models.UpdateGeneGeneralInfoInput) (*models.GeneGeneralInfo, error) {
	panic(fmt.Errorf("not implemented: UpdateGeneGeneralInfo - updateGeneGeneralInfo"))
}
...
func (r *mutationResolver) UploadFile(ctx context.Context, file graphql.Upload) (*models.ImageFile, error) {
