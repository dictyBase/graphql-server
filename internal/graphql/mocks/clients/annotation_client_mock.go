...
func (_m *TaggedAnnotationServiceClient) DeleteAnnotation(ctx context.Context, in *annotation.DeleteAnnotationRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	if rf, ok := ret.Get(0).(func(context.Context, *annotation.DeleteAnnotationRequest, ...grpc.CallOption) *emptypb.Empty); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
...
func (_m *TaggedAnnotationServiceClient) DeleteAnnotationGroup(ctx context.Context, in *annotation.GroupEntryId, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r0 *emptypb.Empty
	if rf, ok := ret.Get(0).(func(context.Context, *annotation.GroupEntryId, ...grpc.CallOption) *emptypb.Empty); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*emptypb.Empty)
...
type mockConstructorTestingTNewTaggedAnnotationServiceClient interface {
	mock.TestingT
	Cleanup(func())
}

// NewTaggedAnnotationServiceClient creates a new instance of TaggedAnnotationServiceClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewTaggedAnnotationServiceClient(t mockConstructorTestingTNewTaggedAnnotationServiceClient) *TaggedAnnotationServiceClient {
	mock := &TaggedAnnotationServiceClient{}
	mock.Mock.Test(t)
