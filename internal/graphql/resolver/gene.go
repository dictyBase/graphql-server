...
func (qrs *QueryResolver) GeneGeneralInformation(
	...
	if err != nil {
		// errorutils.AddGQLError and logging are handled by
		// fetchGeneAnnotation
		return nil, err
	}
	if feat == nil { // Gene not found
		// GraphQL will handle this as null, or you can return a
		// specific GraphQL errornot found
		return nil, nil
	}
	...
	for _, prop := range feat.Attributes.Properties {
		...
		case "name description":
			geneInfo.NameDescription = append(
